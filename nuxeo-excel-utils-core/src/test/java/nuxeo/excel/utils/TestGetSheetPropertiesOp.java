...
import nuxeo.excel.utils.operations.GetSheetPropertiesOp;
...
public class TestGetSheetPropertiesOp {
    ...
    public void shouldCallTheOperation() throws OperationException {
        ...
        DocumentModel doc = (DocumentModel) automationService.run(ctx, GetSheetPropertiesOp.ID);
    ...
    public void shouldCallWithParameters() throws OperationException {
        ...
        DocumentModel doc = (DocumentModel) automationService.run(ctx, GetSheetPropertiesOp.ID, params);
